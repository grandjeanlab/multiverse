...
```
    ...
    Delimiter: "\t"
    chr (11): participant_id, session_id, rat_strain, rat_sex, rat_age, MRI_vend...
    dbl  (3): dataset_id, rat_weight, MRI_field_strength
...
df <- add_exclude(df, ednixgd)
df <- add_exclude(df, ednixgsr)
